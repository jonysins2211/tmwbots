...
API_ID = int(environ.get('API_ID', '28983957')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '3a41093732a0d45317704f3d9d3757f2')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://i.ibb.co/m5PSq2KV/photo-2025-10-08-16-33-53-7558890107336392720.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6617326165 777060241').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002239375158 -1003614473250').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003037006362'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003037006362'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003037006362'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002917127370")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002490192076")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/m5PSq2KV/photo-2025-10-08-16-33-53-7558890107336392720.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Msg to Admin')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://telugumoviesworld:iszCT4PieFzNHrHf@cluster0.peu9dul.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "telugumoviesworld") # Database name (default: cluster)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://manikanta:qyHXWaDxFAi4pzWG@cluster0.k2t9puo.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003085800204'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'b4c7d34c314270ea715cec94ae25ea4a') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003037006362')) #Verification Channel Id  
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003037006362')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/processs_video/9")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/processs_video/9")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/processs_video/9")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "1e465edae91c5cd7b940451d4b0f8dfec71c8109") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "1e465edae91c5cd7b940451d4b0f8dfec71c8109")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "1e465edae91c5cd7b940451d4b0f8dfec71c8109")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "arolinks.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "10800")) # Time gap for two-step verification in seconds (default: 20 minutes)v
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "10800"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+y6JmJ2f1LCYxOTVl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TMW_Admin_Bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/TMW_Channels') # Update channel link for the bot
...
WORKERS = int(environ.get('WORKERS', '20'))
